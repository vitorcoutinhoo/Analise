...
Método de Euler Modificado para resolução de EDOs de primeira ordem.
"""
...
def write_arquive(path, data):
    ...
    with open(path, "w", encoding="utf-8") as arqv:
        arqv.write("Método de Euler Modificado\nTabela de valores:\n\n")
...
def mod_euler_solution(x0, y0, h, n):
    """
...
imports = read_arquive("mod_euler/input.txt")
...
res = mod_euler_solution(x0, y0, h, n)
write_arquive("mod_euler/output.txt", res)
